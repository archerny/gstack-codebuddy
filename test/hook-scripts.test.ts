...
const CAREFUL_SCRIPT = path.join(ROOT, 'skill-templates', 'careful', 'bin', 'check-careful.sh');
const FREEZE_SCRIPT = path.join(ROOT, 'skill-templates', 'freeze', 'bin', 'check-freeze.sh');
