...
import { inspectElement, modifyStyle, resetModifications, getModificationHistory, detachSession } from './cdp-inspector';
import type { InspectorResult } from './cdp-inspector';
...
async function start() {
  ...
  const server = Bun.serve({
    ...
    fetch: async (req) => {
      ...
      // POST /inspector/pick — receive element pick, run CDP inspection
