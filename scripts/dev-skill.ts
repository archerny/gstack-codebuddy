...
const TEMPLATES = [
  { tmpl: path.join(ROOT, 'skill-templates', 'SKILL.md.tmpl'), output: 'dist/claude/gstack/SKILL.md' },
  { tmpl: path.join(ROOT, 'browse', 'SKILL.md.tmpl'), output: 'dist/claude/browse/SKILL.md' },
];
